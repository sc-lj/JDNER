...
parser.add_argument('--bertckp', type=str, required=True,
...
parser.add_argument('--wei_rule', type=str,
                    default="avgaccu", help='weighting rule')
...
WEAKPATH = os.path.join(
    BERTCKP, f'predict/profile/{args.weak_file}profile_data.pickle')
TXTSAVEPATH = os.path.join(
    BERTCKP, f'predict/weak_{args.pred_rule}-WEI_{args.wei_rule}/{args.weak_file}.txt')
WEISAVEPATH = os.path.join(
    BERTCKP, f'predict/weak_{args.pred_rule}-WEI_{args.wei_rule}/{args.weak_file}_wei.npy')

os.makedirs(os.path.join(
    BERTCKP, f'predict/weak_{args.pred_rule}-WEI_{args.wei_rule}'), exist_ok=True)
