...
class ModelArguments:
    ...
    log_soft: bool = field(default=False, metadata={
                           "help": "Set this flag to use fast tokenization."})
    label_X: bool = field(default=False, metadata={
                          "help": "Set this flag to use label X for padding tokens."})
    use_cnn: bool = field(default=False, metadata={
                          "help": "whether to use the cnn for features."})
